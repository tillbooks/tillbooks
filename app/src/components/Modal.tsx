...
export interface ModalProps {
  ...
  trapActive?: boolean;
  /**
   * Where focus lands on open (K-31). Omitted, it is the first focusable, as before. A form dialog
   * passes `firstInvalidOrField` (from `useFocusTrap`) so its first key press never lands on the
   * close control.
   */
