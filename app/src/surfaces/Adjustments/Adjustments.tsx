...
export function Adjustments() {
  ...
  const columns: DataTableColumn<Adjustment>[] = [
    { key: 'date', header: t('adjustments.col.date'), render: (a) => a.effectiveDate },
    ...
    },
    {
      ...
      render: (a) => (
        <>
          <span className="adj-badge">{a.reasonCode}</span> {a.reasonName}
        </>
      ),
    },
    ...
    {
      key: 'actions',
      header: t('adjustments.col.actions'),
      align: 'end',
      render: (a) =>
        a.reversedByAdjustmentId !== null ? (
          <span className="adj-muted">{t('adjustments.reversed')}</span>
        ) : (
          <button
            type="button"
  ...
  return (
    <div className="adj">
      ...
      {failed && <ErrorBanner message={t('adjustments.error.transport')} onRetry={() => void load()} />}
      ...
      <DataTable
        ...
        emptyState={<EmptyState title={t('adjustments.empty.title')} hint={t('adjustments.empty.hint')} />}
      />
        ...
        >
          ...
          <div className="adj-field">
            ...
            <select
              ...
              onChange={(e) => setNewDraft({ ...newDraft, itemId: e.target.value })}
            >
              <option value="">{t('adjustments.form.choose')}</option>
              {items.map((i) => (
          ...
          <div className="adj-field">
            ...
            <select
              ...
              onChange={(e) => setNewDraft({ ...newDraft, locationId: e.target.value })}
            >
              <option value="">{t('adjustments.form.choose')}</option>
              {locations.map((l) => (
          ...
          <div className="adj-field">
            ...
            <select
              ...
              onChange={(e) => setNewDraft({ ...newDraft, reasonCodeId: e.target.value })}
            >
              <option value="">{t('adjustments.form.choose')}</option>
              {reasons.map((r) => (
          ...
          <>
            ...
            <div className="adj-field">
              ...
              <select
                ...
                onChange={(e) => setReverseDraft({ ...reverseDraft, reasonCodeId: e.target.value })}
              >
                <option value="">{t('adjustments.form.choose')}</option>
                {reasons.map((r) => (
                  <option key={r.id} value={r.id}>
