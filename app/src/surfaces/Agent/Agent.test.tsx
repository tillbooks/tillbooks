 ...
 *  - Vertrauen: one row per governed capability; zero history is a sentence, never zeroes; the strong-default pair
...
describe('Vertrauen', () => {
  it('one row per governed capability; zero history is a sentence, never zeroes; the window is stated', async () => {
    ...
    fireEvent.click(await screen.findByRole('tab', { name: 'Vertrauen' }));
