    ...
    <DetailDrawer open onClose={onClose} title={title} closeLabel={t('bills.close')} footer={footer}>
      ...
      {noVendors && (
        <p className="bill-cta">
          ...
          <Link to="/contacts">{t('bills.needsVendor.action')}</Link>
        </p>
      )}

      <div className="bill-form">
        <label className="bill-field" htmlFor="bill-vendor">
          ...
          >
            <option value="">{t('bills.chooseVendor')}</option>
        ...
        */}
        ...
        <label className="bill-field" htmlFor="bill-tax-code">
          ...
          >
            <option value="">{t('bills.noVat')}</option>
            {options.taxCodes.map((c) => (
        ...
        <label className="bill-field" htmlFor="bill-account">
          ...
          >
            <option value="">{t('bills.chooseAccount')}</option>
        ...
        {options.costCenters.length > 0 && (
          <label className="bill-field" htmlFor="bill-cost-center">
            ...
            >
              <option value="">{t('bills.noCostCenter')}</option>
        ...
        {options.projects.length > 0 && (
          <label className="bill-field" htmlFor="bill-project">
            ...
            >
              <option value="">{t('bills.noProject')}</option>
      ...
      <section className={previewing ? 'bill-preview bill-preview--pending' : 'bill-preview'} aria-live="polite">
        ...
        {preview === null ? (
          ...
          <dl className="bill-split">
            <div>
              <dt>{t('bills.net')}</dt>
              <dd className="bill-num">{formatMoney(preview.netMinor, 'CHF')}</dd>
            </div>
            <div>
              <dt>{t('bills.vat')}</dt>
              <dd className="bill-num">{formatMoney(preview.taxMinor, 'CHF')}</dd>
            </div>
            <div>
              <dt>{t('bills.gross')}</dt>
              <dd className="bill-num">{formatMoney(preview.grossMinor, 'CHF')}</dd>
            </div>
          </dl>
        )}
