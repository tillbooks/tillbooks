...
/** A QR-code corner, marking a contact whose structured address is complete. */
export function QrReadyGlyph(props: GlyphProps) {
  return (
    <svg {...base(props)}>
...
/** A small dot-in-circle, marking a contact still missing its structured address. */
export function NeedsAddressGlyph(props: GlyphProps) {
  return (
    <svg {...base(props)}>
