    ...
    <Modal
      ...
      footer={
        <>
          ...
          {/* The dialog's one primary, never the money tint (K-08): `create_credit_note` is always a
              draft. The posting step is the later "Ausstellen" on the draft (the C2 money critic, F5). */}
          <button
            type="button"
      ...
      <div className="documents-confirm-body">
          ...
          {arm === 'amount' && (
            <label className="documents-field">
              ...
              <input className="field t-num" value={amount} onChange={(e) => setAmount(e.target.value)} inputMode="decimal" />
