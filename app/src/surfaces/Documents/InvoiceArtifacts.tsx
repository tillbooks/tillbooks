  ...
  if (qr.kind === 'unavailable') {
    ...
    return (
      <section className="invoice-qr-panel panel" aria-label={t('invoice.qr.title')}>
        ...
        {wayOut !== null && (
          <p className="invoice-qr-unavailable">
            <Link className="link-inline" to={wayOut.to}>{t(wayOut.labelKey)}</Link>
          </p>
        )}
      </section>
    );
    ...
    <section className="invoice-qr-panel panel" aria-label={t('invoice.qr.title')}>
      ...
      <div className="invoice-qr-body">
        ...
        <dl className="invoice-qr-facts">
          ...
          <dd className="t-money">{formatMoney(doc.totalMinor, doc.currency)}</dd>
          {doc.dueDate !== null && (
            <>
    ...
    <Modal
      ...
      footer={
        <>
          ...
          {href !== null && (
            <a className="btn btn--secondary" href={href} download={fileName}>
