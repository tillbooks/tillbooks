  ...
  const footer = (
    <>
      {canAdmin && !file.pendingDelete && (
        <button
          type="button"
          className="btn btn--ghost btn--sm files-delete"
        ...
        <label className="btn btn--secondary btn--sm files-file-label">
          ...
          <input
            ...
            onChange={(event) => {
              ...
              if (picked !== undefined) onNewVersion(file.id, picked);
              event.target.value = '';
            }}
          />
        </label>
                ...
                <li key={version.id} className="files-version">
                  ...
                  {canDownload ? (
                    ...
                    <span className="files-download-locked" title={t('files.error.permissionDenied.download')}>
                      <LockGlyph size={12} />
                      <span className="files-sr">{t('files.action.downloadDenied')}</span>
                    </span>
                  )}
                </li>
              ))}
