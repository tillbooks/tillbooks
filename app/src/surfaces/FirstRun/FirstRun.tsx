 ...
 *
 * K-14: this surface stays reachable as an Einstellungen leaf AFTER provisioning, so it may not
 ...
 * the Übersicht. With zero (or while the read is unresolved, or failed) the original unprovisioned
...
export function FirstRun() {
  ...
  return (
    <main className="firstrun" aria-labelledby="firstrun-title">
      <header className="firstrun-head">
        <h1 id="firstrun-title" className="firstrun-title">
          {t('firstrun.title')}
        </h1>
      ...
      {error !== null && (
        <div className="firstrun-error" role="alert">
          <AlertGlyph className="firstrun-error-glyph" size={18} />
          <span>{error}</span>
        </div>
      )}
      ...
      <div className="firstrun-doors">
        ...
        <article className="firstrun-door" aria-labelledby="door-create">
          ...
          <p className="firstrun-door-verb">{t('firstrun.create.verb')}</p>
        </article>
        ...
        <article className="firstrun-door" aria-labelledby="door-restore">
          ...
          <form onSubmit={onRestore}>
            ...
            <label className="firstrun-field">
              ...
              <input type="text" value={restoreName} onChange={(e) => setRestoreName(e.target.value)} autoComplete="off" />
            </label>
            {verified !== null && (
          ...
          <p className="firstrun-door-verb">{t('firstrun.restore.verb')}</p>
        </article>
        ...
        <article className="firstrun-door" aria-labelledby="door-adopt">
          ...
          <p className="firstrun-door-verb">{t('firstrun.adopt.verb')}</p>
        </article>
      </div>
