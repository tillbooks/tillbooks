...
export function AssetCategories() {
  ...
  const columns: DataTableColumn<Category>[] = [
    ...
    { key: 'residual', header: t('assets.categories.col.residual'), numeric: true, render: (c) => residualLabel(c) },
    {
      ...
      render: (c) => (
        <span className={`fa-badge ${c.active ? 'fa-badge-active' : 'fa-badge-archived'}`}>
          {c.active ? t('assets.categories.active') : t('assets.categories.archived')}
        </span>
      ),
    },
    {
      key: 'actions',
      header: t('assets.categories.col.actions'),
      headerHidden: true,
      align: 'end',
      render: (c) => (
        <div className="fa-row-actions">
          <button type="button" className="btn btn--ghost btn--sm" onClick={() => openEdit(c)} disabled={!canWrite}>
        ...
        <div className="fa-field">
          ...
          <div className="fa-field">
            ...
            <select
              ...
              onChange={(e) => setDraft({ ...draft, glAssetAccountId: e.target.value })}
            >
              <option value="">{t('assets.categories.field.choose')}</option>
              {assetAccounts.map((a) => (
          ...
          <div className="fa-field">
            ...
            <select
              ...
              onChange={(e) => setDraft({ ...draft, glAccumDeprAccountId: e.target.value })}
            >
              <option value="">{t('assets.categories.field.choose')}</option>
          ...
          <div className="fa-field">
            ...
            <select
              ...
              onChange={(e) => setDraft({ ...draft, glDeprExpenseAccountId: e.target.value })}
            >
              <option value="">{t('assets.categories.field.choose')}</option>
          ...
          <div className="fa-field">
            ...
            <select
              ...
              onChange={(e) => setDraft({ ...draft, defaultCostCenterId: e.target.value })}
            >
              <option value="">{t('assets.categories.field.none')}</option>
              {costCenters.map((c) => (
