        ...
        {formError !== null && <ErrorBanner error={formError} />}
          ...
          <div className="item-row2">
            <div className="item-field">
              ...
              {skuError !== null && (
                <span id={`${titleId}-sku-err`} className="item-field-error" role="alert">
                  {skuError}
                </span>
              )}
            </div>
            ...
            <div className="item-field">
              <label className="item-field-inner">
                ...
                <select className="item-input" value={kind} onChange={(event) => setKind(event.target.value)}>
                  <option value="">{t('item.kindNone')}</option>
                  {ITEM_KINDS.map((k) => (
          ...
          <div className="item-row2">
            ...
            <div className="item-field">
              ...
              {costPriceError !== null && (
                <span id={`${titleId}-cost-err`} className="item-field-error" role="alert">
                  {costPriceError}
                </span>
              )}
            </div>
          ...
          <div className="item-row2">
            ...
            <div className="item-field">
              <label className="item-field-inner">
                ...
                <select className="item-input" value={unit ?? ''} onChange={(event) => setUnit(event.target.value)}>
                  <option value="">{t('item.unitNone')}</option>
                  {legacyUnit !== null && <option value={legacyUnit}>{legacyUnit}</option>}
                  {ITEM_UNITS.map((u) => (
          ...
          <div className="item-field">
            <label className="item-field-inner">
              ...
              >
                <option value="">{t('item.categoryNone')}</option>
          ...
          <div className="item-field">
            ...
            {stockError !== null && (
              <span className="item-field-error" role="alert">
                {stockError}
              </span>
            )}
          </div>
