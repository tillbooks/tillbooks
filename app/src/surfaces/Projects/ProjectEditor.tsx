      ...
      >
        ...
        <label className="projects-field">
          ...
          {contacts.length === 0 ? (
            ...
            <span className="projects-hint">
              ...
              <Link className="projects-inline-link" to="/contacts">
        ...
        <div className="projects-field-row">
          ...
          <label className="projects-field">
            ...
            />
            <span id="project-budget-preview" className="projects-hint">
              {budgetPreview ?? ''}
            </span>
          </label>
          <label className="projects-field">
            <span>{t('project.editor.budgetHours')}</span>
            <input type="text" inputMode="numeric" value={budgetHours} onChange={(e) => setBudgetHours(e.target.value)} />
          </label>
        </div>
        ...
        <label className="projects-field">
          ...
          <select value={parentId} onChange={(e) => setParentId(e.target.value)}>
            <option value="">{t('project.editor.parentNone')}</option>
            {parentOptions.map((p) => (
        ...
        {fieldError !== null && (
          <p className="projects-field-error" role="alert">
            {fieldError}
          </p>
        )}
        {error !== null && (
