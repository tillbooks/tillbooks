        ...
        <table className="rp-table">
          ...
          <tbody>
            <tr className="rp-balance-row">
              ...
              <td className="rp-num rp-money">{formatMoney(view.openingMinor, currency)}</td>
              <td />
            </tr>
            {view.lines.map((line, index) => {
              ...
              return (
                <tr key={`${line.entryId}-${String(index)}`}>
                  ...
                  <td className="rp-num rp-money">{formatMoney(line.runningMinor, currency)}</td>
            ...
            <tr className="rp-balance-row">
              ...
              <td className="rp-num rp-money">{formatMoney(view.closingMinor, currency)}</td>
              <td />
            </tr>
          </tbody>
        </table>
